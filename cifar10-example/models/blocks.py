...
class BasicBlock(nn.Module):
    ...
    def __init__(self, channels, kernel_size=(3,3), **kwargs):
        ...
        self.conv0 = Conv(channels, channels, kernel_size=kernel_size)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, channels, kernel_size=(3,3),  **kwargs):
        ...
        self.conv0 = Conv(channels, channels//4, kernel_size=(1,1))
        self.conv1 = Conv(channels//4, channels//4, kernel_size=kernel_size)
        self.conv2 = Conv(channels//4, channels, kernel_size=(1,1))
...
class BranchBlock(nn.Module):
    ...
    def __init__(self, channels, kernel_size=(3,3), branches=2, **kwargs):
